  ...
  const contactInfo = [
    {
      ...
      title: 'Email Us',
      content: 'info@ibm3eng.com',
      link: 'mailto:info@ibm3eng.com'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Call Us',
      content: '+91 98713 58409',
      link: 'tel:+919871358409'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      content: '+91 95406 53396',
      link: 'tel:+919540653396'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Visit Us',
      content: 'H.No. 1203, Sonia Nagar, Sector-31, Near Police Station, Faridabad',
      link: 'https://maps.google.com/?q=28.4089,77.3178'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <a
                key={index}
                href={info.link}
                className="bg-white rounded-2xl p-8 shadow-lg card-hover text-center animate-fade-in-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="w-16 h-16 bg-gradient-to-br from-primary-600 to-accent-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white">
                  {info.icon}
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="machinery">Machinery Repairs & Maintenance</option>
                ...
                <button
                  type="submit"
                  className="w-full btn-primary rounded-full text-lg py-5"
                >
                  Send Message
                </button>
              </form>
      ...
      <section className="h-96 bg-gray-300">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3508.5827399564745!2d77.31554731508019!3d28.408899982492847!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cdc8b1c5fffff%3A0x1234567890abcdef!2sSonia%20Nagar%2C%20Sector%2031%2C%20Faridabad%2C%20Haryana!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
