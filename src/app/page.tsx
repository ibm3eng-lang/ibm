'use client'
import Machinery3D from '@/components/Machinery3d'
...
export default function HomePage() {
  const services = [
    ...
    },
    {
      ...
      color: 'from-indigo-800 to-orange-500'
    }
  ]
  ...
  return (
    <div className="pt-20">
      {/* Hero Section with 3D Machinery Effect */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{background: 'linear-gradient(135deg, #1a1464 0%, #100b37 50%, #0a0820 100%)'}}>
        {/* 3D Machinery Animation */}
        <Machinery3D />
        
        {/* Animated Grid Overlay */}
        <div className="absolute inset-0 z-5 opacity-10" style={{
          backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 50px, rgba(247, 147, 30, .15) 50px, rgba(247, 147, 30, .15) 51px), repeating-linear-gradient(90deg, transparent, transparent 50px, rgba(247, 147, 30, .15) 50px, rgba(247, 147, 30, .15) 51px)',
        }}></div>
          ...
          <div className="max-w-5xl mx-auto text-center">
            <div className="animate-fade-in-down">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold mb-6 leading-tight text-white">
                ENGINEERING
                <span className="block mt-2 bg-gradient-to-r from-orange-400 via-orange-300 to-orange-500 bg-clip-text text-transparent">
                  EXCELLENCE
                </span>
            ...
            <p className="text-xl md:text-3xl text-gray-200 mb-12 max-w-3xl mx-auto font-light leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              Comprehensive solutions for <span className="font-semibold" style={{color: '#e0e7ff'}}>machinery maintenance</span>, 
              <span className="font-semibold" style={{color: '#f7931e'}}> manpower services</span>, and 
              <span className="font-semibold" style={{color: '#fed7aa'}}> accounting excellence</span>
            </p>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-8 animate-fade-in" style={{ animationDelay: '600ms' }}>
              <a href="tel:+919871358409" className="flex items-center text-white transition-colors" onMouseEnter={(e) => e.currentTarget.style.color = '#f7931e'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>
                <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="font-semibold">+91 98713 58409</span>
              </a>
              <a href="tel:+919540653396" className="flex items-center text-white transition-colors" onMouseEnter={(e) => e.currentTarget.style.color = '#f7931e'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>
                <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {services.map((service, index) => (
              <div 
                key={index}
                className="group bg-white rounded-3xl p-10 shadow-xl card-hover animate-fade-in-up border-2 border-transparent" 
              ...
              >
                ...
                <ul className="space-y-3 mb-8">
                  {service.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-start text-gray-700">
                      <svg className="w-6 h-6 mr-3 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" style={{color: '#1a1464'}}>
                ...
                <Link 
                  href="/services" 
                  className="inline-flex items-center font-bold transition-colors group"
                  style={{color: '#1a1464'}}
                  onMouseEnter={(e) => e.currentTarget.style.color = '#f7931e'}
                  onMouseLeave={(e) => e.currentTarget.style.color = '#1a1464'}
                >
                  Learn More
                  <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
      ...
      <section className="py-24 text-white" style={{background: 'linear-gradient(135deg, #1a1464 0%, #100b37 100%)'}}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
      ...
      <section className="py-24 text-white relative overflow-hidden" style={{background: 'linear-gradient(135deg, #1a1464 0%, #f7931e 100%)'}}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            <Link 
              href="/contact" 
              className="inline-flex items-center justify-center px-12 py-6 text-xl font-bold bg-white rounded-full transition-all duration-300 shadow-2xl hover:shadow-3xl transform hover:-translate-y-1"
              style={{color: '#1a1464'}}
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = '#f1f5f9'
                e.currentTarget.style.color = '#1a1464'
              }}
              onMouseLeave={(e) => {
